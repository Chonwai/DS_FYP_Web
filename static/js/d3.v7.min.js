...
!(function (t, n) {
    ...
    function e(t) {
        ...
        return (
            2 !== t.length && ((e = (n, e) => t(n) - e), (r = n), (i = (e, r) => n(t(e), r))),
            {
                left: o,
    ...
    function U(t, n, e) {
        ...
        if (((r = n < t) && ((i = t), (t = n), (n = i)), 0 === (a = I(t, n, e)) || !isFinite(a)))
            return [];
        if (a > 0) {
    ...
    function j() {
        ...
        function r(r) {
            ...
            if (!Array.isArray(h)) {
                const t = l,
                    e = +h;
                if ((n === g && ([s, l] = Y(s, l, e)), (h = U(s, l, e))[h.length - 1] >= l))
                    if (t >= l && n === g) {
                        const t = I(s, l, e);
                        isFinite(t) &&
                            (t > 0
        ...
        return (
            ...
            (r.thresholds = function (t) {
                return arguments.length
                    ? ((e = 'function' == typeof t ? t : Array.isArray(t) ? q(D.call(t)) : q(t)), r)
                    : e;
            }),
            r
        );
    ...
    bt.prototype = _t.prototype = {
        ...
        on: function (t, n) {
            ...
            for (; ++o < a; ) if ((e = (t = i[o]).type) && (e = xt(r[e], t.name))) return e;
        },
        copy: function () {
            var t = {},
                n = this._;
    ...
    Fn.prototype = On.prototype = {
        ...
        style: function (t, n, e) {
            return arguments.length > 1
                ? this.each(
                      (null == n ? nn : 'function' == typeof n ? rn : en)(t, n, null == e ? '' : e)
                  )
                : on(this.node(), t);
        },
            ...
            (n = se.exec(t))
                ? ((e = n[1].length),
                  ...
                  6 === e
                      ...
                      : 8 === e
                      ? we((n >> 24) & 255, (n >> 16) & 255, (n >> 8) & 255, (255 & n) / 255)
                      : 4 === e
                      ? we(
                            ((n >> 12) & 15) | ((n >> 8) & 240),
                            ((n >> 8) & 15) | ((n >> 4) & 240),
    ...
    var zr,
        Dr = 180 / Math.PI,
        qr = { translateX: 0, translateY: 0, rotate: 0, skewX: 0, scaleX: 1, scaleY: 1 };
    ...
    var Or = Fr(
        ...
        Ur = Fr(
            function (t) {
                return null == t
                    ? qr
                    : (zr || (zr = document.createElementNS('http://www.w3.org/2000/svg', 'g')),
    ...
    function li() {
        ui(), ++Jr;
        for (var t, n = Kr; n; ) (t = ri - n._time) >= 0 && n._call.call(void 0, t), (n = n._next);
        --Jr;
    }
    function hi() {
                ...
                (function () {
                    ...
                    for (; e; )
                        e._call
                            ...
                            : ((n = e._next), (e._next = null), (e = t ? (t._next = n) : (Kr = n)));
                    (Qr = t), pi(r);
                })(),
                (ri = 0);
        }
    ...
    function pi(t) {
        Jr ||
            ...
            t - ri > 24
                ...
                : (ni || ((ei = oi.now()), (ni = setInterval(di, 1e3))), (Jr = 1), ai(hi)));
    }
    function gi(t, n, e) {
        var r = new fi();
        return (
        ...
        restart: function (t, n, e) {
            ...
            (e = (null == e ? ui() : +e) + (null == n ? 0 : +n)),
                this._next || Qr === this || (Qr ? (Qr._next = this) : (Kr = this), (Qr = this)),
                (this._call = t),
                (this._time = e),
                pi();
        },
    ...
    Zi.prototype = Ki.prototype = {
        ...
        transition: function () {
            for (
                var t = this._name, n = this._id, e = Qi(), r = this._groups, i = r.length, o = 0;
                o < i;
                ++o
            )
        ...
        function h(e) {
            ...
            function U(t) {
                for (const n of t.changedTouches || [t])
                    for (const t of D) t.identifier === n.identifier && (t.cur = jn(n, _));
                if (z && !y && !v && 1 === D.length) {
                    const t = D[0];
                    ...
                    case zo:
                        D[1]
                            ...
                            : (x < 0
                                  ...
                                  : x > 0 && ((C = Ro(S - l, Fo(k - l, C))), (a = i), (h = l + C)),
                              w < 0
                                  ? ((P = Ro(E - u, Fo(N - u, P))), (c = u + P), (p = d))
                                  : w > 0 && ((P = Ro(E - d, Fo(N - d, P))), (c = u), (p = d + P)));
                        break;
                    case Do:
                        x && ((a = Ro(S, Fo(k, i - C * x))), (h = Ro(S, Fo(k, l + C * x)))),
                            w && ((c = Ro(E, Fo(N, u - P * w))), (p = Ro(E, Fo(N, d + P * w))));
                }
                h < a &&
                    ((x *= -1),
                    (r = i),
    ...
    var Na = (t) => () => t;
    function Ca(t, n) {
        for (var e, r = -1, i = n.length; ++r < i; ) if ((e = Pa(t, n[r]))) return e;
        return 0;
    }
    function Pa(t, n) {
    ...
    function Ra() {
        ...
        function o(e, i) {
            ...
            return (
                (function (e, r, i) {
                    ...
                    for (; ++o < t - 1; ) (c = f), (f = e[o + 1] >= r), qa[c | (f << 1)].forEach(p);
                    qa[f << 0].forEach(p);
                    for (; ++u < n - 1; ) {
                        for (
                            o = -1,
        ...
        return (
            ...
            (i.thresholds = function (t) {
                return arguments.length
                    ? ((e = 'function' == typeof t ? t : Array.isArray(t) ? Na(Ea.call(t)) : Na(t)),
                      i)
                    : e;
            }),
            (i.smooth = function (t) {
        ...
        return Math.abs(c) >= 33306690738754716e-32 * f
            ...
            : -(function (t, n, e, r, i, o, a) {
                  ...
                  if (
                      ...
                      return N;
                  if (
                      ((C = 11093356479670487e-47 * a + 33306690738754706e-32 * Math.abs(N)),
                      (N += T * s + k * u - (E * f + S * c)),
                      N >= C || -N >= C)
                  )
                      return N;
    ...
    class Qa {
        ...
        update() {
            ...
            for (let n = 0; n < o; n++) this._dists[n] = Ja(t[2 * n], t[2 * n + 1], M.x, M.y);
            ...
            for (let o, a, u = 0; u < this._ids.length; u++) {
                ...
                let g,
                    y = l;
                for (; (g = e[y]), Wa(f, s, t[2 * y], t[2 * y + 1], t[2 * g], t[2 * g + 1]) >= 0; )
                    if (((y = g), y === l)) {
                        y = -1;
                        break;
                    }
                ...
                let _ = e[y];
                for (; (g = e[_]), Wa(f, s, t[2 * _], t[2 * _ + 1], t[2 * g], t[2 * g + 1]) < 0; )
                ...
                if (y === l)
                    for (
                        ;
                        (g = n[y]), Wa(f, s, t[2 * g], t[2 * g + 1], t[2 * y], t[2 * y + 1]) < 0;
    ...
    function xu(t) {
        ...
        return isNaN(t)
            ...
            : (function (t) {
                  ...
                  mu(t.getUTCDate(), 2) +
                  (i
                      ? 'T' + mu(n, 2) + ':' + mu(e, 2) + ':' + mu(r, 2) + '.' + mu(i, 3) + 'Z'
                      : r
    ...
    (oc.copy = function () {
        ...
        (oc.addAll = function (t) {
            ...
            for (this.cover(c, f).cover(s, l), e = 0; e < o; ++e) Qu(this, a[e], u[e], t[e]);
            return this;
        }),
    ...
    var af = {
            ...
            FeatureCollection: function (t, n) {
                for (var e = t.features, r = -1, i = e.length; ++r < i; ) of(e[r].geometry, n);
            }
        },
        uf = {
            Sphere: function (t, n) {
            ...
            MultiLineString: function (t, n) {
                for (var e = t.coordinates, r = -1, i = e.length; ++r < i; ) cf(e[r], n, 0);
            },
            Polygon: function (t, n) {
                ff(t.coordinates, n);
            },
            MultiPolygon: function (t, n) {
                for (var e = t.coordinates, r = -1, i = e.length; ++r < i; ) ff(e[r], n);
            },
    ...
    function Ds(t, n, e, r, i, o) {
        if (e) {
            ...
            null == i
                ? ((i = n + r * Uc), (o = n - c / 2))
                : ((i = qs(a, i)), (o = qs(a, o)), (r > 0 ? i < o : i > o) && (i += r * Uc));
    ...
    function Us(t, n, e, r, i) {
        ...
        if (
            ...
            for (c.sort(n), Is(u), Is(c), o = 0, a = c.length; o < a; ++o) c[o].e = e = !e;
            for (var f, s, l = u[0]; ; ) {
            ...
            function b() {
                ...
                if ((u.pop(), o.push(u), (u = null), d))
                    if (1 & c) {
                        ...
                        d > 1 && 2 & c && h.push(h.pop().concat(h.shift())), a.push(h.filter(js));
            }
            return h;
        };
    }
            ...
            (E.clipExtent = function (t) {
                return arguments.length
                    ? ((T =
                          null == t
                              ? ((A = r = i = o = null), Ml)
                              : Js((A = +t[0][0]), (r = +t[0][1]), (i = +t[1][0]), (o = +t[1][1]))),
                      C())
                    : null == A
                    ? null
                    : [
        ...
        return (
            (o.invert = function (t, n) {
                var e = i - n,
                    ...
                    a = jc(t, Yc(e)) * Kc(e);
                return (
                    e * r < 0 && (a -= Rc * Kc(t) * Kc(e)), [a / r, 2 * Lc(Wc(i / o, 1 / r)) - Fc]
                );
            }),
            o
        );
        ...
        return (
            (o.invert = function (t, n) {
                var e = i - n,
                    o = jc(t, Yc(e)) * Kc(e);
                return (
                    e * r < 0 && (o -= Rc * Kc(t) * Kc(e)), [o / r, i - Kc(r) * Qc(t * t + e * e)]
                );
            }),
            o
        );
    ...
    function yd(t, n) {
        var e, r;
        if (bd(n, t)) return [n];
        for (e = 0; e < t.length; ++e) if (vd(n, t[e]) && bd(xd(t[e], n), t)) return [t[e], n];
    ...
    function Xp(n) {
        ...
        function u() {
            return (
                ...
                (o = (function (t) {
                    return 10 === t ? jp : t === Math.E ? Math.exp : (n) => Math.pow(t, n);
                })(a)),
        ...
        return (
            ...
            (e.nice = () =>
                r(Up(r(), { floor: (t) => o(Math.floor(i(t))), ceil: (t) => o(Math.ceil(i(t))) }))),
            e
        );
    }
    function Gp(t) {
    ...
    var gg = ig(
        ...
        Ag = ig(
            ...
            (t, n) => (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * fg) / lg,
            (t) => t.getDate() - 1
        ),
        Tg = Ag,
        Sg = Ag.range;
    ...
    function Sv(t, n) {
        var e = t.getDay();
        return Uy((t = e >= 4 || 0 === e ? zg(t) : zg.ceil(t)).getFullYear() % 1e4, n, 4);
    }
    function Ev(t) {
        var n = t.getTimezoneOffset();
        return (n > 0 ? '-' : ((n *= -1), '+')) + Uy((n / 60) | 0, '0', 2) + Uy(n % 60, '0', 2);
    }
    function kv(t, n) {
    ...
    function Bv(t, n) {
        return (t = Iv(t)), Uy(cy.count(wy(t), t) + (4 === wy(t).getUTCDay()), n, 2);
    }
    function Yv(t) {
        return t.getUTCDay();
    }
    ...
    function Gv(t, n) {
        var e = t.getUTCDay();
        return Uy((t = e >= 4 || 0 === e ? cy(t) : cy.ceil(t)).getUTCFullYear() % 1e4, n, 4);
    }
    function Vv() {
        return '+0000';
    }
    ...
    var h_ = l_('1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf'),
        ...
        g_ = l_('a6cee31f78b4b2df8a33a02cfb9a99e31a1cfdbf6fff7f00cab2d66a3d9affff99b15928'),
        ...
        m_ = l_('8dd3c7ffffb3bebadafb807280b1d3fdb462b3de69fccde5d9d9d9bc80bdccebc5ffed6f'),
    ...
    function tm(t, n, e, r, i, o, a, u) {
        var c = e - t,
            ...
            l = u - o,
            h = l * c - s * f;
        if (!(h * h < jb)) return [t + (h = (s * (n - o) - l * (t - i)) / h) * c, n + h * f];
    }
    ...
    function dx(t, n, e) {
        var r = t._x1 - t._x0,
            ...
            a = (e - t._y1) / (i || (r < 0 && -0)),
            u = (o * i + a * r) / (r + i);
        return (hx(o) + hx(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) || 0;
    }
    function px(t, n) {
        var e = t._x1 - t._x0;
    ...
    (qx.prototype = zx.prototype),
                ...
                if ((u || (u = c = ya()), l < s && ((f = l), (l = s), (s = f)), l > jb))
                    if (p > Gb - jb)
                        u.moveTo(l * Ub(h), l * Yb(h)),
                            u.arc(0, 0, l, h, d, !g),
                            s > jb && (u.moveTo(s * Ub(d), s * Yb(d)), u.arc(0, 0, s, d, h, g));
                    else {
                        var y,
                            v,
                            _ = h,
        ...
        (t.contourDensity = function () {
            ...
            function l(r) {
                ...
                r.forEach(function (r, o, a) {
                    ...
                    Fa({ width: c, height: f, data: i }, { width: c, height: f, data: l }, o >> a),
                    Oa({ width: c, height: f, data: l }, { width: c, height: f, data: i }, o >> a),
                    Fa({ width: c, height: f, data: i }, { width: c, height: f, data: l }, o >> a),
                    Oa({ width: c, height: f, data: l }, { width: c, height: f, data: i }, o >> a),
                    Fa({ width: c, height: f, data: i }, { width: c, height: f, data: l }, o >> a),
                    Oa({ width: c, height: f, data: l }, { width: c, height: f, data: i }, o >> a);
        ...
        (t.drag = function () {
            ...
            function v(t) {
                var n,
                    ...
                    r = t.changedTouches,
                    i = r.length;
                for (n = 0; n < i; ++n) (e = c[r[n].identifier]) && (Vn(t), e('drag', t, r[n]));
            }
            function _(t) {
                var n,
                    e,
        ...
        (t.interpolateRainbow = function (t) {
            ...
            return (Sb.h = 360 * t - 100), (Sb.s = 1.5 - 1.5 * n), (Sb.l = 0.8 - 0.9 * n), Sb + '';
        }),
        ...
        (t.pointers = function (t, n) {
            return (
                t.target &&
                    ((t = Ln(t)), void 0 === n && (n = t.currentTarget), (t = t.touches || [t])),
        ...
        (t.scaleLog = function t() {
            ...
            return (n.copy = () => Dp(n, t()).base(n.base())), xp.apply(n, arguments), n;
        }),
        (t.scaleOrdinal = Ap),
        ...
        (t.stack = function () {
            ...
            return (
                ...
                (i.order = function (t) {
                    return arguments.length
                        ? ((n = null == t ? Mx : 'function' == typeof t ? t : Rb(Array.from(t))), i)
                        : n;
                }),
                (i.offset = function (t) {
        ...
        (t.thresholdFreedmanDiaconis = function (t, n, e) {
            return Math.ceil((e - n) / (2 * ($(t, 0.75) - $(t, 0.25)) * Math.pow(f(t), -1 / 3)));
        }),
        ...
        (t.zoom = function () {
            ...
            function v(t, n) {
                return (n = Math.max(c[0], Math.min(c[1], n))) === t.k ? t : new zx(n, t.x, t.y);
            }
            function _(t, n, e) {
                var r = n[0] - e[0] * t.k,
                    i = n[1] - e[1] * t.k;
            ...
            function A(t, ...n) {
                if (!e && r.apply(this, arguments)) {
                    var i = t.currentTarget,
                        ...
                        s = t.clientX,
                        l = t.clientY;
                    $n(t.view), Rx(t), (a.mouse = [c, this.__zoom.invert(c)]), wi(this), a.start();
                }
                function h(t) {
                    if ((Fx(t), !a.moved)) {
                        var n = t.clientX - s,
                    ...
                    a.event(t).zoom(
                        'mouse',
                        o(_(a.that.__zoom, (a.mouse[0] = jn(t, i)), a.mouse[1]), a.extent, f)
                    );
                }
                function d(t) {
            ...
            return (
                ...
                (y.wheelDelta = function (t) {
                    return arguments.length ? ((a = 'function' == typeof t ? t : Cx(+t)), y) : a;
                }),
                (y.filter = function (t) {
                    return arguments.length ? ((r = 'function' == typeof t ? t : Cx(!!t)), y) : r;
                }),
                (y.touchable = function (t) {
                    return arguments.length ? ((u = 'function' == typeof t ? t : Cx(!!t)), y) : u;
                }),
                (y.extent = function (t) {
                    return arguments.length
                        ? ((i =
