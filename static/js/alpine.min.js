(() => {
    ...
    var We = new MutationObserver(Ue),
        Ge = !1;
    function Ye() {
        We.observe(document, { subtree: !0, childList: !0, attributes: !0, attributeOldValue: !0 }),
            (Ge = !0);
    }
    function Ur() {
    ...
    function Ue(e) {
        ...
        for (let o of r) t.includes(o) || Ct.forEach((s) => s(o));
...
`
        ...
        let r = Object.getPrototypeOf(async function () {}).constructor,
            ...
            o = (() => {
                try {
                    ...
                    return W(s, t, e), Promise.resolve();
                }
            })();
        return (tt[e] = o), o;
    }
    ...
    function _e(e, t, r, n, i) {
        if (typeof t == 'function') {
            let o = t.apply(r, n);
            o instanceof Promise ? o.then((s) => _e(e, s, r, n)).catch((s) => W(s, i, t)) : e(o);
        } else e(t);
    }
    var rt = 'x-';
    function A(e = '') {
    ...
    var ye = (e, t) => ({ name: r, value: n }) => (
            r.startsWith(e) && (r = r.replace(e, t)), { name: r, value: n }
        ),
        xe = (e) => e;
    function Bt(e = () => {}) {
        return ({ name: t, value: r }) => {
            let { name: n, value: i } = Gt.reduce((o, s) => s(o), { name: t, value: r });
    ...
    function Qt() {
        document.body ||
            ...
            F(document, 'alpine:init'),
            F(document, 'alpine:initializing'),
            Ye(),
            Nt((t) => O(t, P)),
            kt((t) => Y(() => tn(t))),
            Pt((t, r) => {
    ...
    function D(e, t = !1) {
        ...
        if (!!e.parentElement) return D(e.parentElement, t);
    }
    function rr(e) {
    ...
    function Se(e, t, { during: r, start: n, end: i } = {}, o = () => {}, s = () => {}) {
        if (
    ...
    var z = {},
        ar = !1;
    function cr(e, t) {
        if ((ar || ((z = w(z)), (ar = !0)), t === void 0)) return z[e];
        (z[e] = t),
            typeof t == 'object' &&
                t !== null &&
    ...
    var gn = Object.prototype.toString,
        hr = (e) => gn.call(e),
        ft = (e) => hr(e).slice(8, -1);
    var Re = (e) => hn(e) && e !== 'NaN' && e[0] !== '-' && '' + parseInt(e, 10) === e;
    var Ce = (e) => {
            let t = Object.create(null);
            return (r) => t[r] || (t[r] = e(r));
        },
        _n = /-(\w)/g,
        Po = Ce((e) => e.replace(_n, (t, r) => (r ? r.toUpperCase() : ''))),
        yn = /\B([A-Z])/g,
        Do = Ce((e) => e.replace(yn, '-$1').toLowerCase()),
        dt = Ce((e) => e.charAt(0).toUpperCase() + e.slice(1)),
        Io = Ce((e) => (e ? `on${dt(e)}` : '')),
        pt = (e, t) => e !== t && (e === e || t === t);
    var mt = new WeakMap(),
        le = [],
    ...
    function L(e, t, r, n, i, o) {
        ...
        if (t === 'clear') s.forEach(c);
            ...
            switch ((r !== void 0 && c(s.get(r)), t)) {
                case 'add':
                    I(e) ? Re(r) && c(s.get('length')) : (c(s.get(V)), Z(e) && c(s.get(ht)));
                    break;
                case 'delete':
                    I(e) || (c(s.get(V)), Z(e) && c(s.get(ht)));
                    break;
                case 'set':
                    Z(e) && c(s.get(V));
                    break;
    ...
    function Me(e = !1, t = !1) {
        return function (n, i, o) {
            ...
            if (i === '__v_raw' && o === (e ? (t ? Mn : wr) : t ? Cn : vr).get(n)) return n;
            let s = I(n);
    ...
    function Sr(e = !1) {
        return function (r, n, i, o) {
            let s = r[n];
            if (!e && ((i = g(i)), (s = g(s)), !I(r) && _t(s) && !_t(i))) return (s.value = i), !0;
            let a = I(r) && Re(n) ? Number(n) < r.length : ae(r, n),
                c = Reflect.set(r, n, i, o);
            return r === g(o) && (a ? pt(i, s) && L(r, 'set', n, i, s) : L(r, 'add', n, i)), c;
        };
    }
    function Pn(e, t) {
        let r = ae(e, t),
    ...
    function In(e) {
        return E(e, 'iterate', I(e) ? 'length' : V), Reflect.ownKeys(e);
    }
    var Ar = { get: An, set: Nn, deleteProperty: Pn, has: Dn, ownKeys: In },
        Or = {
            get: Tn,
            set(e, t) {
                return (
    ...
    function Le(e, t = !1) {
        return (e = e.__v_raw), !t && E(g(e), 'iterate', V), Reflect.get(e, 'size', e);
    }
    function Tr(e) {
        e = g(e);
        let t = g(this);
        return Pe(t).has.call(t, e) || (t.add(e), L(t, 'add', e, e)), this;
    }
    function Cr(e, t) {
        t = g(t);
        let r = g(this),
            { has: n, get: i } = Pe(r),
            o = n.call(r, e);
        o ? Rr(r, n, e) : ((e = g(e)), (o = n.call(r, e)));
        let s = i.call(r, e);
        return r.set(e, t), o ? pt(t, s) && L(r, 'set', e, t, s) : L(r, 'add', e, t), this;
    }
    function Mr(e) {
        let t = g(this),
            { has: r, get: n } = Pe(t),
            i = r.call(t, e);
        i ? Rr(t, r, e) : ((e = g(e)), (i = r.call(t, e)));
    ...
    function $e(e, t) {
        return function (n, i) {
            let o = this,
                ...
                a = g(s),
                c = t ? bt : e ? xt : yt;
            return !e && E(a, 'iterate', V), s.forEach((l, u) => n.call(i, c(l), c(u), o));
        };
    }
    function je(e, t, r) {
        return function (...n) {
        ...
        return function (...t) {
            {
                ...
                console.warn(`${dt(e)} operation ${r}failed: target is readonly.`, g(this));
            }
    ...
    b('data', (e) => N(j(e)));
    b('root', (e) => D(e));
    b('refs', (e) => (e._x_refs_proxy || (e._x_refs_proxy = N(zn(e))), e._x_refs_proxy));
    function zn(e) {
        let t = [],
            r = e;
    ...
    function Hn(e, t) {
        e._x_undoAddedStyles && e._x_undoAddedStyles(), (e._x_undoAddedStyles = K(e, t));
    }
    function qn(e, t, r) {
        ...
        return (
            ...
            (n, i) =>
                h(() => {
                    ...
                    if (e.type === 'checkbox')
                        if (Array.isArray(i)) {
                            let o = t.includes('number') ? wt(n.target.value) : n.target.value;
                            return n.target.checked ? i.concat([o]) : i.filter((s) => !ni(s, o));
                                  ...
                                  );
                        {
                            ...
                            return t.includes('number') ? wt(o) : t.includes('trim') ? o.trim() : o;
                        }
                    }
                })
        );
    ...
    p('cloak', (e) => queueMicrotask(() => h(() => e.removeAttribute(A('cloak')))));
    tr(() => `[${A('init')}]`);
    p(
        'init',
        J((e, { expression: t }) =>
    ...
    function oi(e, t, r, n) {
        ...
        n(() => {
            ...
            i((s) => {
                ...
                a = a.filter(
                    (l) =>
                        !(typeof l.value == 'object' && !Array.isArray(l.value) && l.value !== null)
                );
                let c = qt(a);
                (a = a.map((l) =>
        ...
        r((s) => {
            ...
            if (i(s))
                s = Object.entries(s).map(([f, _]) => {
                    let x = Kr(t, _, f, s);
                    n((C) => u.push(C), { scope: { index: f, ...x } }), l.push(x);
                });
            else
            ...
            for (let f = 0; f < c.length; f++) {
                let _ = c[f];
                u.indexOf(_) === -1 && R.push(_);
            }
            c = c.filter((f) => !R.includes(f));
            let de = 'template';
            for (let f = 0; f < u.length; f++) {
                ...
                if (x === -1) c.splice(f, 0, _), d.push([de, f]);
                    ...
                    let C = c.splice(f, 1)[0],
                        k = c.splice(x - 1, 1)[0];
                    c.splice(f, 0, k), c.splice(x, 0, C), y.push([C, k]);
                } else B.push(_);
                de = _;
            }
            ...
            for (let f = 0; f < y.length; f++) {
                ...
                h(() => {
                    k.after(H), C.after(k), H.before(C), H.remove();
                }),
                    Qe(k, l[u.indexOf(x)]);
            }
            for (let f = 0; f < d.length; f++) {
                ...
                U(pe, w(k), o),
                    ...
                    typeof H == 'object' &&
                        we('x-for key cannot be an object, it must be a string or an integer', o),
                    (a[H] = pe);
            }
            for (let f = 0; f < B.length; f++) Qe(a[B[f]], l[u.indexOf(B[f])]);
            o._x_prevKeys = u;
        });
    }
    function ci(e) {
    ...
    p(
        'on',
        J((e, { value: t, modifiers: r, expression: n }, { cleanup: i }) => {
            let o = n ? m(e, n) : () => {},
                s = fe(e, t, r, (a) => {
